    ...
    <main className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 pt-6 pb-10">
        <div className="mb-6 animate-fade-up">
          <h1 className="text-display font-semibold mb-2 tracking-tight">{t('opportunities.title').slice(0, parseInt(t('opportunities.split')))}<span className="bg-gradient-to-r from-[#FF6B6B] to-[#FF8E53] bg-clip-text text-transparent">{t('opportunities.title').slice(parseInt(t('opportunities.split')))}</span></h1>
