...
import { groq, MODEL, MODEL_FAST, groqChat } from '@/lib/groq'
...
export async function POST(req) {
  try {
    ...
    const extractChat = await groqChat({
      model: MODEL_FAST,
      temperature: 0.2,
      messages: [
        {
...
## Related`
    ...
    await admin.from('wiki_index').upsert(
    ...
    await admin.from('wiki_log').upsert({
      id: 1,
