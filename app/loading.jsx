  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative max-w-3xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20 pb-12 sm:pb-16 text-center">
        <div className="skeleton w-40 h-7 rounded-full mx-auto mb-5" />
        <div className="skeleton w-72 h-12 rounded mx-auto mb-3" />
        <div className="skeleton w-56 h-12 rounded mx-auto mb-5" />
        <div className="skeleton w-64 h-4 rounded mx-auto mb-8" />
        <div className="flex flex-col sm:flex-row gap-2 max-w-lg mx-auto">
          <div className="skeleton flex-1 h-12 rounded-xl" />
          <div className="skeleton w-28 h-12 rounded-xl" />
        </div>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-8 sm:pb-12">
        ...
        <div className="space-y-1.5">
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="skeleton rounded-xl px-4 py-3">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-12 sm:pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="skeleton rounded-xl p-5 h-32" />
          ))}
        </div>
      </section>
    </main>
