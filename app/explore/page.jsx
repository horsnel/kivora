    ...
    <main className="min-h-screen bg-[#0a0a0a]">
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20 pb-12 sm:pb-16 text-center">
        ...
        <div className="relative">
          ...
          <h1 className="text-display font-semibold mb-2 tracking-tight animate-fade-up animate-fade-up-1">
            {t('home.title1')} <span className="text-red-500">{t('home.title2')}</span>
          </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {cards.map(card => (
                  <button
                    ...
                    className="bg-[#141414] border border-white/[0.06] rounded-xl p-5 sm:p-6 text-left transition-all group hover:-translate-y-0.5 hover:border-white/[0.1] hover:bg-[#161616]"
                  >
                    ...
                    {card.result && (
                      <div className="space-y-1.5">
                        ...
                        <div className="flex items-center gap-3 text-caption text-muted2">
                          ...
                          <span className="flex items-center gap-1"><IconEye size={12} />{(card.views || 0).toLocaleString()}</span>
                        </div>
                      </div>
                    )}
                    <div className="flex flex-wrap gap-1 mt-3">
                      {(card.result?.tags || []).slice(0, 2).map(tag => (
          ...
          {cards.length === 0 && (
            <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-12 sm:pb-16 text-center">
              <div className="bg-[#141414] rounded-xl p-8 sm:p-12">
                ...
                <h3 className="font-semibold text-headline-sm mb-2 tracking-tight text-muted">{t('home.empty_title')}</h3>
